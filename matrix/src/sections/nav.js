...
export function showResTab(tab){
  resActiveTab=tab;
  ['roster','plan','dashboard','skills','skillrisk','profiles','ninebox','disc','timeline','development','heatmap','analytics','portfolio','econ','exec','engagement','backlog'].forEach(function(t){
