...
export var I18N_DICT = {
  fr: {
    ...
    'FTE THIS MONTH':'ETP CE MOIS', 'demand':'demande',
    ...
    'PROJ ALLOC COST':'COÛT ALLOC. PROJET', 'from allocation plan':'depuis le plan d\'allocation',
  ...
  zh: {
    ...
    'FTE THIS MONTH':'本月全职当量', 'demand':'需求',
    ...
    'PROJ ALLOC COST':'项目分配成本', 'from allocation plan':'来自分配计划',
